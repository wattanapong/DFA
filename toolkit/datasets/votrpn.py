...
from .videorpn import Video
from .video_oneshot import VideoOneShot


class VOTOneShot(VideoOneShot):
    """
    Args:
        name: video name
        root: dataset root
    ...
    def __init__(self, name, root, video_dir, init_rect, img_names, gt_rect,
            camera_motion, illum_change, motion_change, size_change, occlusion, load_img=False, config=None):
        super(VOTOneShot, self).__init__(name, root, video_dir,
                init_rect, img_names, gt_rect, None, load_img, config=config)
    ...
    def __init__(self, name, dataset_root, load_img=False, config=None, dataset_toolkit=None):
        ...
        for video in pbar:
            ...
            if dataset_toolkit == 'oneshot':
                self.videos[video] = VOTOneShot(video,
                                              dataset_root,
