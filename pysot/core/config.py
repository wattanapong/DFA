...
__C.TRAIN.start_lr = 3e-2
__C.TRAIN.end_lr = 5e-4
...
__C.DATASET.ROOT = '/media/wattanapongsu/4T/dataset'

__C.DATASET.VID = CN()
__C.DATASET.VID.ROOT = os.path.join(__C.DATASET.ROOT, 'vid/crop511')
__C.DATASET.VID.ANNO = os.path.join(__C.DATASET.ROOT, 'vid/crop511/train.json')
__C.DATASET.VID.FRAME_RANGE = 100
__C.DATASET.VID.NUM_USE = 100000  # repeat until reach NUM_USE

__C.DATASET.YOUTUBEBB = CN()
__C.DATASET.YOUTUBEBB.ROOT = os.path.join(__C.DATASET.ROOT, 'yt_bb/crop511')
__C.DATASET.YOUTUBEBB.ANNO = os.path.join(__C.DATASET.ROOT, 'yt_bb/crop511/train.json')
__C.DATASET.YOUTUBEBB.FRAME_RANGE = 3
__C.DATASET.YOUTUBEBB.NUM_USE = -1  # use all not repeat

__C.DATASET.COCO = CN()
__C.DATASET.COCO.ROOT = os.path.join(__C.DATASET.ROOT, 'coco/crop511')
__C.DATASET.COCO.ANNO = os.path.join(__C.DATASET.ROOT, 'coco/train2017.json')
__C.DATASET.COCO.FRAME_RANGE = 1
__C.DATASET.COCO.NUM_USE = -1

__C.DATASET.DET = CN()
__C.DATASET.DET.ROOT = os.path.join(__C.DATASET.ROOT, 'det/DET_crop/crop511')
__C.DATASET.DET.ANNO = os.path.join(__C.DATASET.ROOT, 'det/DET_crop/train.json')
